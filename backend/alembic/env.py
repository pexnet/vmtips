...
# Override sqlalchemy.url with the configured DATABASE_URL from config.py
# This reads the same env var / .env file the application uses.
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        # support ALTER TABLE; Alembic uses batch mode instead.
        context.configure(
